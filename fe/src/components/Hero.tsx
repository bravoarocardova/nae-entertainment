...
const Hero = () => {
    return (
        <header className="relative min-h-[100svh] flex items-center justify-center overflow-hidden bg-zinc-950">
            {/* Background elements */}
            <div className="absolute inset-0 z-0">
                <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-transparent to-zinc-950 z-10"></div>
                <div className="absolute inset-0 bg-gradient-to-r from-red-950/20 via-transparent to-red-950/20 z-10"></div>
                
                <div 
                    className="w-full h-full bg-[url('https://images.unsplash.com/photo-1470225620780-dba8ba36b745?auto=format&fit=crop&q=80&w=2070')] bg-cover bg-center opacity-30 scale-105 animate-[pulse_12s_infinite_alternate]"
            ...
            <div className="relative z-20 text-center px-6 max-w-5xl mx-auto" data-aos="zoom-out-up" data-aos-duration="1200">
                <div className="inline-block mb-10 group relative">
                    ...
                    <div className="relative flex flex-col items-center">
                        <div className="p-1 rounded-full bg-zinc-950/50 backdrop-blur-xl border border-white/10 shadow-2xl overflow-hidden mb-4">
                            <img 
                ...
                <h1 className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-black mb-8 tracking-tighter leading-[0.85] px-2 text-white">
                    WE CREATE <br />
                ...
                <p className="text-base sm:text-xl md:text-2xl text-zinc-400 mb-10 sm:mb-12 max-w-2xl mx-auto px-4 font-medium leading-relaxed">
                    Membangun masa depan hiburan digital. Mewujudkan imajinasi menjadi mahakarya visual yang tak terlupakan.
                </p>
                    ...
                    >
                        <a href={`https://www.youtube.com/${import.meta.env.VITE_YOUTUBE_USERNAME || "@NAEEntertainment-nrb"}`} target="_blank" rel="noreferrer">
                            <span className="relative z-10 flex items-center gap-2">
                                LIHAT KARYA KAMI <Play className="w-5 h-5 fill-current" />
                            </span>
                        </a>
                    </Button>
                    <Button 
                        ...
                        variant="outline"
                        size="lg"
                        className="group border-2 border-white/10 bg-white/5 backdrop-blur-md text-white rounded-full font-black text-lg hover:bg-white hover:text-black hover:border-white transition-all duration-500 py-7 px-8"
                    >
            ...
            <div className="absolute -left-20 top-1/2 -rotate-90 hidden lg:block opacity-5 pointer-events-none select-none">
                <span className="text-8xl font-black tracking-widest uppercase">Creativity</span>
            </div>
            <div className="absolute -right-20 top-1/2 rotate-90 hidden lg:block opacity-5 pointer-events-none select-none">
                <span className="text-8xl font-black tracking-widest uppercase">Production</span>
            </div>
        </header>
    );
};
