...
const CTA = () => {
    return (
        <section className="py-24 sm:py-32 px-6 bg-zinc-950 border-white/5">
            <div className="max-w-6xl mx-auto" data-aos="zoom-in-up">
                <div className="bg-red-600 rounded-[3rem] p-10 sm:p-16 md:p-24 text-center relative overflow-hidden shadow-[0_30px_60px_rgba(220,38,38,0.4)]">
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                        <Badge className="mb-8 bg-white/20 text-white backdrop-blur-md border-white/20 px-6 py-2 rounded-full font-black tracking-widest text-xs">JOIN THE MOVEMENT</Badge>
                        ...
                        <p className="text-lg sm:text-xl md:text-2xl text-red-50 mb-12 max-w-2xl mx-auto font-bold opacity-90 leading-tight">
                            Bergabunglah dengan jutaan fans lainnya. Subscribe ke channel YouTube kami sekarang untuk konten eksklusif.
                        </p>
